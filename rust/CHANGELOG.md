...
### Fixed
- Improved error messages for "assistant stream produced no content" error
- Added detailed troubleshooting hints for API response issues

## [0.3.2] - 2026-04-16

### Fixed
- Fixed Backspace key for both SSH (MobaXterm) and local terminal
- Removed stty configuration from run_claw.sh to avoid breaking local terminal
- ^H (ASCII 8) handling in input.rs works universally for all terminal types
